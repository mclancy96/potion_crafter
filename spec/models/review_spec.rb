...
RSpec.describe Review, type: :model do
  ...
  describe '.most_recent' do
    it 'returns the most recent reviews by default (limit 3)' do
      ...
      most_recent = Review.most_recent
    ...
    it 'respects a custom limit' do
      ...
      most_recent = Review.most_recent(2)
  ...
  describe '#edited?' do
    context 'when the created_at and updated_at are different' do
      it 'returns true' do
        review = create(:review, created_at:'2025-09-09 14:59:51.730008000 UTC +00:00', updated_at: '2025-09-18 14:59:51.730008000 UTC +00:00')
    ...
    context 'when the created_at and updated_at are the same' do
      it 'returns false' do
        review = create(:review, created_at:'2025-09-09 14:59:51.730008000 UTC +00:00', updated_at: '2025-09-09 14:59:51.730008000 UTC +00:00')
  ...
  describe '#formatted_created_at' do
    it 'returns the formatted created_at string' do
      time = Time.new(2025, 9, 10, 14, 30, 0)
  ...
  describe '#formatted_updated_at' do
    it 'returns the formatted updated_at string' do
      time = Time.new(2025, 9, 10, 16, 45, 0)
